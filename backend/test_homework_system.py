...
class TestSemester:
    ...
    async def test_create_semester_success(self):
        doc = {
            "_id": ObjectId(),
            "year": "113", "grade": "大三", "semester": "上學期",
...
class TestCourse:
    ...
    async def test_create_course_success(self):
        doc = {
            "_id": ObjectId(),
            "semester_id": "sem01", "course_name": "軟體工程",
            "teacher": "王老師", "class_time": "", "credits": 3
        }
        insert_result = MagicMock()
        insert_result.inserted_id = doc["_id"]
...
class TestHomeworkUrgent:
    ...
    async def test_deadline_today_mark_today(self):
        ...
        hw = {
            ...
            "status": "未完成", "score": 0, "image_id": None
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}

        with patch("routers.homeworks.homeworks_col") as hw_col, \
    ...
    async def test_deadline_day3_mark_empty(self):
        ...
        hw = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "homework_name": "HW1", "deadline": "2025-05-04",
            "difficulty": "中等", "description": "",
            "status": "未完成", "score": 0, "image_id": None
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_deadline_day7_in_list(self):
        ...
        hw = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "homework_name": "HW1", "deadline": "2025-05-08",
            "difficulty": "中等", "description": "",
            "status": "未完成", "score": 0, "image_id": None
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_deadline_day8_not_in_list(self):
        ...
        hw = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "homework_name": "HW1", "deadline": "2025-05-09",
            "difficulty": "中等", "description": "",
            "status": "未完成", "score": 0, "image_id": None
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
...
class TestExamUpcoming:
    ...
    async def test_exam_today_mark_today(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-01",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
        with patch("routers.exams.exams_col") as ex_col, \
    ...
    async def test_exam_day3_mark_urgent(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-04",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_exam_day4_mark_this_week(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-05",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_exam_day7_mark_this_week(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-08",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_exam_day8_mark_empty(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-09",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_exam_day14_in_list(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-15",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
    ...
    async def test_exam_day15_not_in_list(self):
        ...
        exam = {
            "_id": ObjectId(), "course_id": str(ObjectId()),
            "exam_name": "期中考", "exam_date": "2025-05-16",
            "exam_time": "", "location": "", "scope": "", "notes": "",
            "status": "未考", "score": 0
        }
        course = {"_id": ObjectId(), "course_name": "軟體工程"}
